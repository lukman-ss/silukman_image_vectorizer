...
def test_resume_filters_completed_runs(dummy_experiment, monkeypatch):
    ...
    runner = ExperimentRunner(dummy_experiment["config_path"], dummy_experiment["resume_id"], retry_failed=False)
    runner.setup()
...
def test_resume_retry_failed(dummy_experiment, monkeypatch):
    ...
    runner = ExperimentRunner(dummy_experiment["config_path"], dummy_experiment["resume_id"], retry_failed=True)
    runner.setup()
