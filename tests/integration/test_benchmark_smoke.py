...
def smoke_env(tmp_path):
    ...
    with open(manifest_path, "w") as f:
        f.write("image_id,filename,split,category,complexity\n")
        f.write(f"img1,{img1.name},test,shape,low\n")
        f.write(f"img2,{img2.name},test,shape,low\n")
