...
class UnifiedQualityEvaluator:
    ...
    def evaluate(
        ...
        record = {
            ...
            "complexity": {"svg_bytes": None, "path_count": None, "command_count": None},
            "performance": {"duration_seconds": None, "peak_memory_mb": None},
            "errors": [],
        }

        # 1. Performance Formatting (if provided)
        if performance_data:
            record["performance"]["duration_seconds"] = performance_data.get(
