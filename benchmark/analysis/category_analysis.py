...
class CategoryAnalyzer:
    ...
    def __init__(self, aggregated_json_path: str):
        ...
        if "by_category" not in self.data:
            raise ValueError("Aggregated data must contain 'by_category' grouping for category analysis.")
            ...
            for preset, categories in presets.items():
                ...
                for cat, stats in categories.items():
                    ...
                    cat_profile["category_metrics"][cat] = {
                        ...
                        "runtime_median_sec": metrics.get("wall_clock_time_seconds", {}).get("median"),
